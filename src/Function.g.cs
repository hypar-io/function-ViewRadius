...
namespace ViewRadius
{
    public class Function
    {
        ...
        private UrlModelStore<ViewRadiusInputs> store;

        public async Task<ViewRadiusOutputs> Handler(ViewRadiusInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<ViewRadiusInputs>();
            }
