...
namespace ViewRadius
{
    ...
    public  class ViewRadiusInputs : ArgsBase
    
    {
        [Newtonsoft.Json.JsonConstructor]
        
        public ViewRadiusInputs(double @height, double @maxRadius, Dictionary<string, string> modelInputKeys, string gltfKey, string elementsKey, string ifcKey):
        ...
        public double Height { get; set; } = 50D;
        ...
        public double MaxRadius { get; set; } = 500D;
